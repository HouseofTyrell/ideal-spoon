...
# Audio codec overlays from actual Kometa repository
AUDIO_CODEC_ASSETS = {
    "truehd": "audio_codec/standard/truehd.png",
    "dolby_truehd": "audio_codec/standard/truehd.png",
    "atmos": "audio_codec/standard/atmos.png",
    "dolby_atmos": "audio_codec/standard/dolby_atmos.png",
    "dolby atmos": "audio_codec/standard/dolby_atmos.png",
    "dts": "audio_codec/standard/dts.png",
    "dts-hd": "audio_codec/standard/ma.png",
    "dts-hd ma": "audio_codec/standard/ma.png",
    "dts_hd_ma": "audio_codec/standard/ma.png",
    "ma": "audio_codec/standard/ma.png",
    "dtsx": "audio_codec/standard/dtsx.png",
    "dts-x": "audio_codec/standard/dtsx.png",
    "dts_x": "audio_codec/standard/dtsx.png",
    "aac": "audio_codec/standard/aac.png",
    "flac": "audio_codec/standard/flac.png",
}

# HDR overlays are dynamically generated by Kometa (no PNG assets)
HDR_ASSETS = {
    # HDR overlays are dynamically generated - no PNG assets
}

# Ribbon overlays from actual Kometa repository
RIBBON_ASSETS = {
    "imdb_top_250": "ribbon/yellow/imdb.png",
    "imdb": "ribbon/yellow/imdb.png",
    "rt_certified_fresh": "ribbon/yellow/rotten.png",
    "rotten_tomatoes": "ribbon/yellow/rotten.png",
    "rotten": "ribbon/yellow/rotten.png",
}

# Ratings assets from actual Kometa repository
RATINGS_ASSETS = {
    "imdb": "rating/IMDb.png",
    "tmdb": "rating/TMDb.png",
    "rt_critics": "rating/RT-Crit-Fresh.png",  # Default to Fresh for critics score
    "rt_fresh": "rating/RT-Crit-Fresh.png",
    "rt_rotten": "rating/RT-Crit-Rotten.png",
    "imdb_top_250": "rating/IMDbTop250.png",
}
...
def get_audio_codec_asset(codec: str) -> Optional[bytes]:
    ...
    codec_lower = codec.lower().replace(" ", "_").replace("-", "_")
    ...
    # Try variations
    for key, path in AUDIO_CODEC_ASSETS.items():
        if codec_lower in key or key in codec_lower:
            return download_asset(path)

    print(f"No audio codec asset found for: {codec}")
    return None
...
def preload_common_assets(force_refresh: bool = False):
    ...
    common_assets = [
        ...
        # Audio codec overlays (actual Kometa PNG assets)
        "audio_codec/standard/truehd.png",
        "audio_codec/standard/atmos.png",
        "audio_codec/standard/dolby_atmos.png",
        "audio_codec/standard/dts.png",
        "audio_codec/standard/ma.png",
        "audio_codec/standard/dtsx.png",
        "audio_codec/standard/aac.png",
        "audio_codec/standard/flac.png",
        # Rating overlays (actual Kometa PNG assets)
        "rating/IMDb.png",
        "rating/TMDb.png",
        "rating/RT-Crit-Fresh.png",
        "rating/RT-Crit-Rotten.png",
        "rating/IMDbTop250.png",
        # Ribbon overlays (actual Kometa PNG assets)
        "ribbon/yellow/imdb.png",
        "ribbon/yellow/rotten.png",
